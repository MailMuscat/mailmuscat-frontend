...
const Signup = () => {
  return (
    <>
      <div className="w-full max-w-sm p-6 m-auto  rounded-md shadow-md bg-darkBlue">
        ...
        <form className="mt-6">
            ...
            <div className="mt-4">
                <div className="flex items-center justify-between">
                    <label htmlFor="password" className="block text-sm text-gray-800 dark:text-gray-200">Confirm Password</label>
        ...
        <div className="flex items-center mt-6 -mx-2">
            <button type="button"
                className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-200 transform  rounded-md bg-blue focus:outline-none">
